...
final class AppSettings: ObservableObject {
    ...
    @Published var followCursorScreen: Bool { didSet { d.set(followCursorScreen, forKey: "followCursorScreen") } }
    ...
    private init() {
        ...
        followCursorScreen = d.object(forKey: "followCursorScreen") as? Bool ?? false
